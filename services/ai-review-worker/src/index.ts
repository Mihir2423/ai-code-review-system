...
---
*This summary was automatically generated by AI Code Review System*
`;

        const updatedDescription = existingDescription.includes('## AI Code Review Summary')
            ? existingDescription.replace(
                  /---[\s\S]*?\*This summary was automatically generated by AI Code Review System\*[\s\S]*?---/m,
        ...
        logger.info({ owner, repo, prNumber }, 'Updated PR description with AI review summary');
    } catch (error) {
...
async function startWorker(): Promise<void> {
    aiReviewWorker = createWorker(QUEUE_NAME, async (job) => {
        ...
        try {
            ...
            updatePRDescription(owner, repo, prNumber, summaryMessage, octokit);
